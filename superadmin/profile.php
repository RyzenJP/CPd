...
if (!$user) {
    ...
    if (!isset($user['role'])) {
        $user['role'] = $_SESSION['role'] ?? 'superadmin';
    }
}
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-4">
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                    <div class="h-32 bg-[#1a237e] relative">
                                ...
                                <div class="w-32 h-32 rounded-3xl overflow-hidden border-4 border-white shadow-lg bg-white">
                                    ...
                                    <?php else: ?>
                                        <div class="w-full h-full bg-blue-50 flex items-center justify-center">
                                            <i class="bi bi-person-fill text-[#1a237e] text-5xl"></i>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="pt-16 pb-8 px-6 text-center">
                        <h2 class="text-xl font-black text-[#1a237e] mb-1">
                        ...
                        <div class="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-50 text-[#1a237e] text-xs font-bold border border-blue-100 uppercase tracking-wider mb-6">
                            <span class="w-2 h-2 rounded-full bg-[#1a237e] mr-2 animate-pulse"></span>
                        ...
                        <div class="grid grid-cols-1 gap-3 text-left border-t border-gray-50 pt-6">
                            <div class="flex items-center justify-between p-3 rounded-2xl bg-gray-50/50 hover:bg-gray-50 transition-colors">
                                ...
                                <span class="text-[#1a237e] font-bold text-sm"><?php echo date('M d, Y', strtotime($user['created_at'])); ?></span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-2xl bg-gray-50/50 hover:bg-gray-50 transition-colors">
                                <span class="text-gray-500 text-sm">Username</span>
                                <span class="text-[#1a237e] font-bold text-sm">@<?php echo htmlspecialchars($user['username'], ENT_QUOTES, 'UTF-8'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="px-8 py-6 border-b border-gray-50 flex items-center justify-between bg-white">
                        <div class="flex items-center">
                            <div class="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center mr-4">
                                <i class="bi bi-person-gear text-[#1a237e] text-xl"></i>
                            </div>
                            <h3 class="text-lg font-black text-[#1a237e] uppercase tracking-tight">Edit Profile Information</h3>
                        </div>
                    </div>
                    ...
                    <div class="p-8">
                        <form method="post" enctype="multipart/form-data" class="space-y-6">
                                        ...
                                        <div class="relative">
                                            <input type="file" name="profile_picture" accept="image/*" 
                                                   class="block w-full text-sm text-gray-500
                                                          ...
                                                          file:bg-blue-50 file:text-[#1a237e]
                                                          hover:file:bg-[#1a237e] hover:file:text-white
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="first_name" required
                                           class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-4 focus:ring-[#1a237e]/10 focus:border-[#1a237e] transition-all outline-none font-medium"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" name="email" required
                                               class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 focus:ring-4 focus:ring-[#1a237e]/10 focus:border-[#1a237e] transition-all outline-none font-medium"
                            ...
                            <div class="pt-4 border-t border-gray-50 flex justify-end">
                                <button type="submit" 
                                        class="px-8 py-3 bg-[#1a237e] text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-opacity-90 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 flex items-center">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-8 py-6 border-b border-gray-50 flex items-center justify-between bg-white">
                        <div class="flex items-center">
                            ...
                            <h3 class="text-lg font-black text-[#1a237e] uppercase tracking-tight">Security & Password</h3>
                        </div>
                    </div>
                    ...
                    <div class="p-8">
                        ...
                        <form method="post" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="password" name="current_password" required
                                       class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-4 focus:ring-[#1a237e]/10 focus:border-[#1a237e] transition-all outline-none">
                            </div>
                        ...
                        <div class="mt-10 pt-8 border-t border-gray-50">
                            <h4 class="text-sm font-black text-[#1a237e] uppercase tracking-wider mb-4">Security Best Practices</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-start p-4 rounded-2xl bg-gray-50/50">
                                    <i class="bi bi-check2-circle text-[#1a237e] mt-0.5 mr-3"></i>
                                ...
                                <div class="flex items-start p-4 rounded-2xl bg-gray-50/50">
                                    <i class="bi bi-box-arrow-right text-[#1a237e] mt-0.5 mr-3"></i>
                                    <p class="text-xs text-gray-600 leading-relaxed">Always log out when using a shared or public computer.</p>
                                </div>
                                <div class="flex items-start p-4 rounded-2xl bg-gray-50/50">
                                    <i class="bi bi-browser-chrome text-[#1a237e] mt-0.5 mr-3"></i>
