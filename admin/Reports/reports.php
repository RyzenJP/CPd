            ...
            <div class="card-body">
                ...
                <div id="step1ReportType">
                    ...
                    <div class="card border-0 bg-light mb-3">
                        <button type="button" class="btn w-100 text-start p-3 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#governmentStandardReports" aria-expanded="false">
                        ...
                        <div id="governmentStandardReports" class="collapse mt-2">
                    ...
                    <div class="card border-0 bg-light">
                        <button type="button" class="btn w-100 text-start p-3 d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#systemReports" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                <div class="report-type-icon me-3">
                        ...
                        <div id="systemReports" class="collapse mt-2">
                            <div class="card-body pt-0">
                                <div class="row g-3">
                                    <div class="col-md-4">
                ...
                <form id="rpciForm" action="print_file.php" method="POST" target="_blank">
                        ...
                        <div class="card-body py-2">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-6 col-12 d-flex gap-2">
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="applyRpciFilter()">Apply</button>
                                    ...
                                    <?php if ($rpci_filter_active): ?>
                                        <div class="small text-muted align-self-center">
                                            Showing items with transactions from <strong><?php echo htmlspecialchars($rpci_start_date); ?></strong> to <strong><?php echo htmlspecialchars($rpci_end_date); ?></strong>.
                                        </div>
                                    <?php else: ?>
                                        <div class="small text-muted align-self-center">
                                            Optional: filter items by transaction date range.
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM items WHERE status = 'Active' ORDER BY item ASC";
                                if ($rpci_filter_active) {
                                    ...
                                    $sql = "
                                        ...
                                        AND DATE(t.transaction_date) BETWEEN '$rpci_start_esc' AND '$rpci_end_esc'
                                        ORDER BY i.item ASC
                                    ";
                                }
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo date('M d, Y', strtotime($row['request_date'])); ?></td>
                    ...
                    <div class="card border-0 bg-light mb-3">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                <div class="col-md-4">
                                    <label class="form-label text-secondary fw-semibold small">Start date</label>
                                    <input type="date" id="ris_filter_start" class="form-control" value="<?php echo $start_date; ?>">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label text-secondary fw-semibold small">End date</label>
                                    <input type="date" id="ris_filter_end" class="form-control" value="<?php echo $end_date; ?>">
                                </div>
                                <div class="col-md-4 d-flex justify-content-md-end gap-2 mt-3 mt-md-0">
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="filterRisPreview()">
                                        <i class="bi bi-funnel me-2"></i>Apply filter
                                    </button>
                                    <button type="button" class="btn btn-primary btn-sm" id="risGenerateBtnSmall">
                                        <i class="bi bi-file-earmark-pdf me-2"></i>Generate RIS
                                    </button>
                                </div>
                            </div>
                            <div class="mt-2 text-muted small">
                                Showing RIS requests from <?php echo date('M d, Y', strtotime($start_date)); ?> to <?php echo date('M d, Y', strtotime($end_date)); ?>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <div class="small text-muted">
                                            Edit RIS header details and signatories before generating the report.
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-md-6">
...
<script>
    ...
    function filterRisPreview() {
        ...
        window.location.href = `reports.php?start_date=${startDate}&end_date=${endDate}&rt=ris`;
    }
    ...
    function applyRpciFilter() {
        ...
        window.location.href = `reports.php?rt=rpci&rpci_start_date=${startDate}&rpci_end_date=${endDate}`;
    }
