    ...
    <div class="container-fluid">
                ...
                <tr>
                    <td class="p-3">
                        ...
                        <div class="row text-center mb-4">
                            <div class="col-4">
                                <div class="fw-bold"><?php echo htmlspecialchars($rpci_certified_name_officer_v); ?></div>
                                <div class="small"><?php echo htmlspecialchars($rpci_certified_title_officer_v); ?></div>
                            </div>
                            <div class="col-4">
                                <div class="fw-bold"><?php echo htmlspecialchars($rpci_certified_name_acting_officer_i); ?></div>
                                <div class="small"><?php echo htmlspecialchars($rpci_certified_title_acting_officer_i); ?></div>
                            </div>
                            <div class="col-4">
                                <div class="fw-bold"><?php echo htmlspecialchars($rpci_certified_name_accountant_ii); ?></div>
                        ...
                        <div class="row mt-4">
                            <div class="col-6">
                                ...
                                <div class="fw-bold"><?php echo htmlspecialchars($rpci_approved_name); ?></div>
                                <div class="small"><?php echo htmlspecialchars($rpci_approved_position_title); ?></div>
                            </div>
                            <div class="col-6">
                                <div class="fw-bold mb-2">Verified by:</div>
                                <div class="fw-bold"><?php echo htmlspecialchars($rpci_verified_name); ?></div>
        ...
        <table class="table table-bordered w-100 mb-3 border-dark">
            ...
            <tr>
                ...
                <td class="p-2">
                    <strong>Property Number:</strong> <?php echo htmlspecialchars($pc_property_number); ?>
                </td>
            </tr>
            <tr>
                <td colspan="2" class="p-2">
                    <strong>Description :</strong> <?php echo htmlspecialchars($pc_description); ?>
                </td>
            </tr>
        </table>
        ...
        <table class="table table-bordered w-100 mb-3 border-dark">
            ...
            <tr>
                ...
                <td class="p-2">
                    <div>PTR No. : <?php echo htmlspecialchars($ptr_no); ?></div>
