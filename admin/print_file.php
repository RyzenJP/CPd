...
$rlsddp_fund_cluster = $_POST['rlsddp_fund_cluster'] ?? '';
$rlsddp_department = $_POST['rlsddp_department'] ?? '';
$rlsddp_accountable_officer = $_POST['rlsddp_accountable_officer'] ?? '';
$rlsddp_office_address = $_POST['rlsddp_office_address'] ?? '';
$rlsddp_position = $_POST['rlsddp_position'] ?? '';
$rlsddp_tel_no = $_POST['rlsddp_tel_no'] ?? '';
$rlsddp_date = $_POST['rlsddp_date'] ?? '';
$rlsddp_no = $_POST['rlsddp_no'] ?? '';
$rlsddp_pc_no = $_POST['rlsddp_pc_no'] ?? '';
$rlsddp_par_no = $_POST['rlsddp_par_no'] ?? '';
$rlsddp_circumstances = $_POST['rlsddp_circumstances'] ?? '';

// SC variables
$sc_entity_name = $_POST['sc_entity_name'] ?? 'COMMISSION ON POPULATION AND DEVELOPMENT - REGION VI';
$sc_fund_cluster = $_POST['sc_fund_cluster'] ?? '';
$sc_reorder_point = $_POST['sc_reorder_point'] ?? '';
$sc_inspected_by = $_POST['sc_inspected_by'] ?? '';
$sc_inspected_date = $_POST['sc_inspected_date'] ?? '';
$sc_verified_by = $_POST['sc_verified_by'] ?? '';
$sc_verified_date = $_POST['sc_verified_date'] ?? '';

// SLC variables
$slc_entity_name = $_POST['slc_entity_name'] ?? 'COMMISSION ON POPULATION AND DEVELOPMENT - REGION VI';
$slc_fund_cluster = $_POST['slc_fund_cluster'] ?? '';
$slc_reorder_point = $_POST['slc_reorder_point'] ?? '';
$sc_item_id = 0;
$sc_transactions = [];
        ...
        <table class="table table-bordered table-sm w-100">
            <thead class="table-light">
                <tr>
                    ...
                    <th>Date</th>
                    <th>Item Type</th>
                    <th class="text-end">In-stocks</th>
                    <th class="text-end">Quantity Add</th>
            ...
            <tbody>
                <?php if(empty($inventory_tx_data)): ?>
                    <tr><td colspan="8" class="text-center py-3">No records found.</td></tr>
                <?php else: ?>
                    <?php foreach($inventory_tx_data as $tx): 
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($tx['remarks'] ?? $tx['transaction_type']); ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
        ...
        <table class="table table-bordered table-sm w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $isInbound ? rtrim(rtrim(number_format($qty, 2, '.', ''), '0'), '.') : ''; ?></td>
                    <td class="text-center"><?php echo $isOutbound ? rtrim(rtrim(number_format($qty, 2, '.', ''), '0'), '.') : ''; ?></td>
                    <td><?php echo $isOutbound ? htmlspecialchars($reference_display) : ''; ?></td>
        ...
        <table class="table table-bordered table-sm w-100">
            <thead>
                <tr>
                    ...
                    <th rowspan="2" style="width: 12%;">Reference</th>
                    <th colspan="3" class="text-center" style="width: 24%;">Receipt</th>
                    <th colspan="3" class="text-center" style="width: 24%;">Issue</th>
                    <th colspan="3" class="text-center" style="width: 24%;">Balance</th>
                    <th rowspan="2" style="width: 7%;">No. of Days to Consume</th>
                </tr>
                <tr>
                    <th class="text-center">Qty.</th>
                    <th class="text-end">Unit Cost</th>
